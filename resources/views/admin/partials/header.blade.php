@php
    ...
    $menu = [
        ...
        'publishing' => ['route' => 'admin.manual-publications.index', 'name' => __('admin.nav.publishing')],
    ...
    $subMap = [
        ...
        'admin.manual-publications.index' => 'publishing',
        'admin.manual-publications.create' => 'publishing',
        'admin.manual-publications.show' => 'publishing',
        'admin.manual-publications.edit' => 'publishing',
        'admin.manual-publications.settings.index' => 'publishing',
