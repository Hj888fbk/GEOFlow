...
final class CommandSpec
{
    ...
    public static function all(): array
    {
        return [
            ...
            'article.ai-quality-recheck' => self::spec('article.ai-quality-recheck', ['article', 'ai-quality-recheck'], 3, ['config-version', 'idempotency-key'], 'article.ai-quality-recheck', false, 'article ai-quality-recheck ARTICLE_ID --config-version VERSION [--idempotency-key KEY]'),
    ...
    public static function apiExamples(): iterable
    {
        $examples = [
            ...
            'article.ai-quality-recheck' => [['article', 'ai-quality-recheck', '10', '--config-version', '1'], ['article' => 10]],
