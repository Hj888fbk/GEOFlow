...
return array_replace_recursive($base, [
    ...
    'readiness' => [
        'ready' => 'Pronta', 'unbound' => 'Sem conta vinculada',
        'gap_inactive' => 'Conta inativa', 'gap_adapter' => 'Adaptador de navegador não habilitado',
        'gap_editor_url' => 'URL do editor ausente', 'gap_identity' => 'Identidade da conta ausente',
    ],
]);
