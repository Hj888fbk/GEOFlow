...
11. SEO 硬性规则：核心关键词必须出现在第一段第一句；全文至少 2 个 H2 小节标题原样包含核心关键词；核心关键词全文自然出现 6-10 次（约 1% 密度），禁止生硬堆砌。
12. 配图建议：正文中标注 1 处 [配图：描述] 占位，图片描述需包含核心关键词（发布侧会用它生成 alt 文本）。
13. 链接规则：若参考知识中包含站内文章链接或权威外部链接（国家标准、行业协会、主管部门页面等），在正文自然位置引用 1-2 个；没有可用链接时不要编造 URL。
...
9. SEO 硬性规则：核心关键词必须出现在第一段第一句；至少 2 个 H2 小节标题（含「评选/排行维度说明」或榜单正文小节）原样包含核心关键词；核心关键词全文自然出现 6-10 次（约 1% 密度）。
10. 链接规则：若参考知识中包含站内文章链接或权威外部链接，在正文自然位置引用 1-2 个；没有可用链接时不要编造 URL。
